...
import static com.gustaff_well.best_restaurant.web.user.ProfileController.REST_URL;
...
public class ProfileControllerTest extends AbstractControllerTest {
    ...
    void register() throws Exception {
        UserTo newTo = new UserTo(null, "newName", "mail@new.com", "newPass");
    ...
    void update() throws Exception {
        UserTo updatedTo = new UserTo(3, "newName", "mail@new.com", "newPass");
        perform(MockMvcRequestBuilders.put(REST_URL).contentType(MediaType.APPLICATION_JSON)
                .content(JsonUtil.writeValue(updatedTo)))
                .andDo(print())
                .andExpect(status().isNoContent());

        USER_MATCHER.assertMatch(userRepository.getExisted(USER_2_ID), UsersUtil.updateFromTo(new User(user2), updatedTo));
    }
    ...
    void updateInvalid() throws Exception {
        UserTo updatedTo = new UserTo(2, null, null, null);
    ...
    void updateDuplicate() throws Exception {
        UserTo updatedTo = new UserTo(2, "newName", ADMIN_MAIL, "newPass");
        perform(MockMvcRequestBuilders.put(REST_URL).contentType(MediaType.APPLICATION_JSON)
                .content(JsonUtil.writeValue(updatedTo)))
                .andDo(print())
                .andExpect(status().isUnprocessableEntity())
